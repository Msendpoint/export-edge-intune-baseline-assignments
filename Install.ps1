<#
.SYNOPSIS
    One-click installer and launcher for Export Microsoft Edge Intune Security Baseline Assignments
...
Write-Host "    Export Microsoft Edge Intune Security Baseline Assignments" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/export-edge-intune-baseline-assignments.ps1"
